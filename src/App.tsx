...
import { darkTheme, lightTheme } from "./themes/harmonyTheme";
          ...
          <Toolbar>
            <Grid justify="space-between" alignItems="center" alignContent="center" container>
              ...
              <Grid item>
                ...
                />
                <LanguageMenu />
                <Tooltip title={t("Harmony ") as string}>
                  <IconButton
                    onClick={() =>
                      window.open("https://harmony.one") //tslint:disable-line
                    }>
                    <NotesIcon />
                  </IconButton>
                </Tooltip>
                <Tooltip title={t("API") as string}>
                  <IconButton
                    onClick={() =>
                      window.open("https://docs.harmony.one/home/developers/api")
                    }>
                    <CodeIcon />
                  </IconButton>
                </Tooltip>
